...
> Quando uma oportunidade for validada e tiver dono, **mover** para `SEO_BACKLOG.md`.
...
- **Mover** para `SEO_BACKLOG.md` quando validada e priorizada.
...
- **Próximo passo**: SEO Lead — atualizar `STRATEGY_KEYWORDS.md` cluster Formação; brief P1.
