# .claude/commands/seo-growth-system/ (pontes)

Estes comandos foram **consolidados** no comando único `/seo` do module.

- `seo-audit.md` → `/seo audit`
- `content-review.md` → `/seo content` (e `/seo brief`)
- `competitor-review.md` → `/seo competitor`
